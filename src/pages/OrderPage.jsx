        ...
        <form className="card p-7" onSubmit={saveProfile}>
          ...
          <div className="mt-5 space-y-3">
            <label className="space-y-1 block">
              ...
              <input className="input" value={profileDraft.name} onChange={(event) => setProfileDraft({ ...profileDraft, name: event.target.value })} required />
            </label>
            <label className="space-y-1 block">
              <span className="label">電話 *</span>
              <input className="input" value={profileDraft.phone} onChange={(event) => setProfileDraft({ ...profileDraft, phone: event.target.value })} required inputMode="tel" />
            </label>
          </div>
